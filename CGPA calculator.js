function sem() {
    ...
    if (v == 2) {
        ...
        t.innerHTML += '<input type="text" id="sg12" style="border:2px solid black;">' + '<br><br>';
    }
    if (v == 3) {
        ...
        t.innerHTML += '<br>' + '<br>';
        t.innerHTML += "SGPA of SEM-I                        ";
        t.innerHTML += '<input type="text" id="sg13" style="border:2px solid black;">' + '<br><br>';

        t.innerHTML += "SGPA of SEM-II                       ";
        t.innerHTML += '<input type="text" id="sg23" style="border:2px solid black;">' + '<br><br>';
    }
    if (v == 4) {
        ...
        t.innerHTML += '<br>' + '<br>';
        t.innerHTML += "SGPA of SEM-I                        ";
        t.innerHTML += '<input type="text" id="sg14" style="border:2px solid black;">' + '<br><br>';

        t.innerHTML += "SGPA of SEM-II                       ";
        t.innerHTML += '<input type="text" id="sg24" style="border:2px solid black;">' + '<br><br>';

        t.innerHTML += "SGPA of SEM-III                      ";
        t.innerHTML += '<input type="text" id="sg34" style="border:2px solid black;">' + '<br><br>';
    }
    if (v == 5) {
        ...
        t.innerHTML += '<br>' + '<br>';
        t.innerHTML += "SGPA of SEM-I                        ";
        t.innerHTML += '<input type="text" id="sg15" style="border:2px solid black;">' + '<br><br>';

        t.innerHTML += "SGPA of SEM-II                       ";
        t.innerHTML += '<input type="text" id="sg25" style="border:2px solid black;">' + '<br><br>';

        t.innerHTML += "SGPA of SEM-III                      ";
        t.innerHTML += '<input type="text" id="sg35" style="border:2px solid black;">' + '<br><br>';

        t.innerHTML += "SGPA of SEM-IV                       ";
        t.innerHTML += '<input type="text" id="sg45" style="border:2px solid black;">' + '<br><br>';
    }
    if (v == 6) {
        ...
        t.innerHTML += '<br>' + '<br>';
        t.innerHTML += "SGPA of SEM-I                        ";
        t.innerHTML += '<input type="text" id="sg16" style="border:2px solid black;">' + '<br><br>';

        t.innerHTML += "SGPA of SEM-II                       ";
        t.innerHTML += '<input type="text" id="sg26" style="border:2px solid black;">' + '<br><br>';

        t.innerHTML += "SGPA of SEM-III                      ";
        t.innerHTML += '<input type="text" id="sg36" style="border:2px solid black;">' + '<br><br>';

        t.innerHTML += "SGPA of SEM-IV                       ";
        t.innerHTML += '<input type="text" id="sg46" style="border:2px solid black;">' + '<br><br>';

        t.innerHTML += "SGPA of SEM-V                        ";
        t.innerHTML += '<input type="text" id="sg56" style="border:2px solid black;">';
    }
    if (v == 7) {
        ...
        t.innerHTML += '<br>' + '<br>';
        t.innerHTML += "SGPA of SEM-I                        ";
        t.innerHTML += '<input type="text" id="sg17" style="border:2px solid black;">' + '<br><br>';

        t.innerHTML += "SGPA of SEM-II                       ";
        t.innerHTML += '<input type="text" id="sg27" style="border:2px solid black;">' + '<br><br>';

        t.innerHTML += "SGPA of SEM-III                      ";
        t.innerHTML += '<input type="text" id="sg37" style="border:2px solid black;">' + '<br><br>';

        t.innerHTML += "SGPA of SEM-IV                       ";
        t.innerHTML += '<input type="text" id="sg47" style="border:2px solid black;">' + '<br><br>';

        t.innerHTML += "SGPA of SEM-V                        ";
        t.innerHTML += '<input type="text" id="sg57" style="border:2px solid black;">' + '<br><br>';

        t.innerHTML += "SGPA of SEM-VI                       ";
        t.innerHTML += '<input type="text" id="sg67" style="border:2px solid black;">';
    }
    if (v == 8) {
        ...
        t.innerHTML += '<br>' + '<br>';
        t.innerHTML += "SGPA of SEM-I                        ";
        t.innerHTML += '<input type="text" id="sg18" style="border:2px solid black;">' + '<br><br>';

        t.innerHTML += "SGPA of SEM-II                       ";
        t.innerHTML += '<input type="text" id="sg28" style="border:2px solid black;">' + '<br><br>';

        t.innerHTML += "SGPA of SEM-III                      ";
        t.innerHTML += '<input type="text" id="sg38" style="border:2px solid black;">' + '<br><br>';

        t.innerHTML += "SGPA of SEM-IV                       ";
        t.innerHTML += '<input type="text" id="sg48" style="border:2px solid black;">' + '<br><br>';

        t.innerHTML += "SGPA of SEM-V                        ";
        t.innerHTML += '<input type="text" id="sg58" style="border:2px solid black;">' + '<br><br>';

        t.innerHTML += "SGPA of SEM-VI                       ";
        t.innerHTML += '<input type="text" id="sg68" style="border:2px solid black;">' + '<br><br>';

        t.innerHTML += "SGPA of SEM-VII                      ";
        t.innerHTML += '<input type="text" id="sg78" style="border:2px solid black;">';
    }
...
function calcsg() {
    ...
    if (v == 1) {
        ...
        val += ((document.getElementById("a").value).toUpperCase());                                        //ASCII value s==83
        val += ((document.getElementById("b").value).toUpperCase());
        val += ((document.getElementById("c").value).toUpperCase());
        val += ((document.getElementById("d").value).toUpperCase());
        val += ((document.getElementById("e").value).toUpperCase());
        val += ((document.getElementById("f").value).toUpperCase());
        val += ((document.getElementById("g").value).toUpperCase());
        val += ((document.getElementById("h").value).toUpperCase());
        val += ((document.getElementById("i").value).toUpperCase());
        ftotalc = 20;
    }
    else if (v == 2) {
        ...
        ftotalc = 46;
        fobtc += document.getElementById("sg12").value * 20;
